...
TIER3_STOCKS = {
    ...
    # TATAMOTORS removed from NSE F&O (demerged → TMPV)
    'TMPV': {'lot_size': 800, 'strike_interval': 10, 'liquidity': 'HIGH', 'sector': 'AUTO'},
    'M&M': {'lot_size': 200, 'strike_interval': 25, 'liquidity': 'HIGH', 'sector': 'AUTO'},
    ...
    'TATASTEEL': {'lot_size': 5500, 'strike_interval': 2.5, 'liquidity': 'HIGH', 'sector': 'METALS'},
    'HINDALCO': {'lot_size': 700, 'strike_interval': 10, 'liquidity': 'HIGH', 'sector': 'METALS'},
    'JSWSTEEL': {'lot_size': 675, 'strike_interval': 10, 'liquidity': 'HIGH', 'sector': 'METALS'},
    'ADANIENT': {'lot_size': 309, 'strike_interval': 25, 'liquidity': 'HIGH', 'sector': 'CONGLOMERATE'},
    'ADANIPORTS': {'lot_size': 475, 'strike_interval': 25, 'liquidity': 'HIGH', 'sector': 'INFRA'},
    'DIVISLAB': {'lot_size': 100, 'strike_interval': 50, 'liquidity': 'MEDIUM', 'sector': 'PHARMA'},
    'LUPIN': {'lot_size': 425, 'strike_interval': 25, 'liquidity': 'MEDIUM', 'sector': 'PHARMA'},
    'WIPRO': {'lot_size': 3000, 'strike_interval': 5, 'liquidity': 'HIGH', 'sector': 'IT'},
    'TECHM': {'lot_size': 600, 'strike_interval': 25, 'liquidity': 'HIGH', 'sector': 'IT'},
    'POWERGRID': {'lot_size': 1900, 'strike_interval': 5, 'liquidity': 'HIGH', 'sector': 'POWER'},
    ...
    'BRITANNIA': {'lot_size': 125, 'strike_interval': 50, 'liquidity': 'MEDIUM', 'sector': 'FMCG'},
    'NESTLEIND': {'lot_size': 500, 'strike_interval': 50, 'liquidity': 'MEDIUM', 'sector': 'FMCG'},
    'HINDUNILVR': {'lot_size': 300, 'strike_interval': 25, 'liquidity': 'HIGH', 'sector': 'FMCG'},
    'EICHERMOT': {'lot_size': 100, 'strike_interval': 50, 'liquidity': 'MEDIUM', 'sector': 'AUTO'},
    ...
    'TVSMOTOR': {'lot_size': 175, 'strike_interval': 25, 'liquidity': 'MEDIUM', 'sector': 'AUTO'},
    'UPL': {'lot_size': 1355, 'strike_interval': 5, 'liquidity': 'MEDIUM', 'sector': 'AGRI'},
    'GRASIM': {'lot_size': 250, 'strike_interval': 25, 'liquidity': 'MEDIUM', 'sector': 'CEMENT'},
    'ULTRACEMCO': {'lot_size': 50, 'strike_interval': 50, 'liquidity': 'MEDIUM', 'sector': 'CEMENT'},
    ...
    'ABB': {'lot_size': 125, 'strike_interval': 50, 'liquidity': 'MEDIUM', 'sector': 'INDUSTRIAL'},
    'PIDILITIND': {'lot_size': 500, 'strike_interval': 25, 'liquidity': 'MEDIUM', 'sector': 'CHEMICALS'},
    'SRF': {'lot_size': 200, 'strike_interval': 25, 'liquidity': 'MEDIUM', 'sector': 'CHEMICALS'},
    'HAVELLS': {'lot_size': 500, 'strike_interval': 25, 'liquidity': 'MEDIUM', 'sector': 'ELECTRICAL'},
    'POLYCAB': {'lot_size': 125, 'strike_interval': 50, 'liquidity': 'MEDIUM', 'sector': 'ELECTRICAL'},
    ...
    'GODREJPROP': {'lot_size': 275, 'strike_interval': 25, 'liquidity': 'MEDIUM', 'sector': 'REALESTATE'},
    'OBEROIRLTY': {'lot_size': 350, 'strike_interval': 25, 'liquidity': 'MEDIUM', 'sector': 'REALESTATE'},
}
